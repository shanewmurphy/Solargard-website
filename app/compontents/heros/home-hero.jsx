        ...
        <div>
          <picture>
            <img
              ...
              className="bg-cover bg-no-repeat w-full bg-center lg:h-[80vh] md:h-[60vh] sm:h-[60vh]"
          ...
          <div className="absolute bottom-0 flex items-center">
            <h1 className="text-white lg:font-bold md:font-bold sm:font-semibold lg:text-4xl md:text-3xl sm:text-base lg:w-[75%] lg:pb-16 lg:pl-24 md:pb-16 md:pl-16 sm:px-8 sm:py-8 z-10 opacity-100">
